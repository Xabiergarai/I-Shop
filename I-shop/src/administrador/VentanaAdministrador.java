...
public class VentanaAdministrador extends JFrame {
	...
	public VentanaAdministrador(JFrame va) {
		...
		//ventanaAnterior = va; //Para volver a la ventana desde la que se llam� a esta
		ventanaActual = this; //ventana guarda la venta es curso
		setBounds(800, 300, 400, 200); //Le damos las dimensiones a la ventana
		setTitle("Bienvenido Administrador, �Que operaci�n desea realizar?"); //Le asignamos un t�tulo a la ventana
		...
		/*Los a�adimos a un grupo para que s�lo pueda estar seleccionado uno de ellos*/
		ButtonGroup grupo = new ButtonGroup();
		grupo.add(rbtnAudio);
		grupo.add(rbtnOrdenador);
		grupo.add(rbtnSmartphone);
		grupo.add(rbtnTelevision);
		/*A�adimos los 2 radio button al panel con las 2 filas*/
